...
namespace ImGui
{
    ...
    IMGUI_API bool          TextButton(const char* label, float sizemultiply , bool* v, const ImVec2& size_arg = ImVec2(0,0));
    IMGUI_API bool          KeyButton(const char* label , const ImVec2& size_arg = ImVec2(0,0));
    // Widgets: Combo Box
